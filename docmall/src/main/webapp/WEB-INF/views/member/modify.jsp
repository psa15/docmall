	  ...
	  <div class=" mb-3 text-center">
	    <form id="modifyForm" method="post" action="join">
		  <div class="form-group row">
		    ...
		    <div class="col-sm-5">
		      <input type="text" class="form-control" id="m_userid" name="m_userid" value="${memberVO.m_userid}" readonly>
		    </div>
		  </div>
		  <div class="form-group row">
		  ...
		  <div class="form-group row">
		    ...
		    <div class="col-sm-10">
		      <input type="text" class="form-control" id="m_username" name="m_username" value="${memberVO.m_username}">
		    </div>
		  </div>
		  <div class="form-group row">
		    <label for="m_nickname" class="col-sm-2 col-form-label">닉네임</label>
		    <div class="col-sm-10">
		      <input type="text" class="form-control" id="m_nickname" name="m_nickname" value="${memberVO.m_nickname}">
		    </div>
		  </div>
		  <div class="form-group row">
		  ...
		  <div class="form-group row">
		    ...
		    <div class="col-sm-10">
		      <input type="text" class="form-control" id="sample2_postcode" name="m_postnum" value="${memberVO.m_postnum}">
		  ...
		  <div class="form-group row">
		    ...
		    <div class="col-sm-10">
		      <input type="text" class="form-control" id="sample2_address" name="m_addr" value="${memberVO.m_addr}">
		    </div>
		  </div>
		  <div class="form-group row">
		    <label for="sample2_detailAddress" class="col-sm-2 col-form-label">상세주소</label>
		    <div class="col-sm-10">
		      <input type="text" class="form-control" id="sample2_detailAddress" name="m_addr_d" value="${memberVO.m_addr_d}">
		  ...
		  <div class="form-group row">
	      	...
	      	<div class="col-sm-10 text-left">
		    	<input type="checkbox" class="form-check-input" id="m_email_accept" name="m_email_accept" ${memberVO.m_email_accept == 'Y' ? 'checked' : ''}>
		    	<%-- value속성을 따로 적지 않고 수신동의에 체크하면 m_email_accept=on 이 값이 들어감
		    		 체크하지 않으면 null값이 들어감 --%>		
		    </div>	    		    
		  </div>
		  
	      <button type="button" class="btn btn-dark text-center" id="btnModify">수정</button>
