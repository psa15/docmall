...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content container-fluid">
      ...
      <div class="row">
      	<div class="col-md-12">
      	<form id="productForm" method="post" action="productModify" enctype="multipart/form-data">
      		<div class="box box-primary">
      			...
      			<div class="box-body">      				
					  <div class="form-group row">
					  	...
					  	<!-- 페이지 및 검색 정보 : AdProductController의 상품수정 폼 매핑 주소의 파라미터인  @ModelAttribute("cri") Criteria cri-->
					    ...
					    <div class="col-sm-10">
					      <select id="first_ct_code" name="f_ct_code">
					      	...
					      	<c:forEach items="${firstCateList}" var="cateList">
					      		<option value="${cateList.ct_code}" ${cateList.ct_code == productVO.f_ct_code ? 'selected' : ''} }>${cateList.ct_name}</option>					      	
					      	</c:forEach>
					      </select>
					      <select id="second_ct_code" name="s_ct_code">
					      	<option  value="">2차 카테고리 선택 </option>
					      	<c:forEach items="${secCateList}" var="secCateList">
					  ...
					  <div class="form-group row">  				  
					    ...
					    <div class="col-sm-10">
					      <textarea class="form-control" id="p_detail" name="p_detail" rows="3">${productVO.p_detail}</textarea>					     
					    </div>
					  </div>
					  <div class="form-group row">
